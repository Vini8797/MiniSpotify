...
Projeto desenvolvido com Spring Boot para simular funcionalidades básicas de uma plataforma de streaming de música, inspirado no Spotify.
...
Vá até a classe principal:
MiniSpotifyApplication.java
Execute a aplicação (botão ▶️ ou Shift + F10)
🔹 Após rodar
...
Isso significa que a API está rodando em:
